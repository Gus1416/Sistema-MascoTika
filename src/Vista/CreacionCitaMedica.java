...
public class CreacionCitaMedica extends javax.swing.JInternalFrame {
    
    private String ID ;
    
    public int generarnum(){
    int randomNum = ThreadLocalRandom.current().nextInt(01, 98 + 1);
    jTextField2.setText("CT"+ randomNum);
    ID="CT"+randomNum;
    return randomNum;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Detalles de Cita");

        jLabel2.setText("Fecha");

        jLabel3.setText("ID de Cita");
    ...
    int cedulacliente=  Integer.parseInt(jTextField4.getText());        
 
    CitaMedica citamed=   new CitaMedicaDAO().insertar(idcitamed, datee, estado, cedulacliente);
      if (citamed==null ){
